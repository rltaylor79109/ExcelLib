...
' Date Last Modified: 2026-09-06
'------------------------------------------------------------------------------'
Public Function SumVisibleRow(rng As Range) As Double
  On Error GoTo Err_Proc
  Const METHOD_NAME As String = "SumVisibleRow"
...
'------------------------------------------------------------------------------'
Public Function RngContainsVal(rng As Range, val As Variant) As Boolean
  On Error GoTo Err_Proc
